...
class Buffer(torch.nn.Module):
    def __init__(self, model, params):
        ...
        input_size = input_size_match(model=params.model, reshape224=params.reshape224)[params.data]
        buffer_img = torch.FloatTensor(buffer_size, *input_size).fill_(0)
        buffer_label = torch.LongTensor(buffer_size).fill_(0)
